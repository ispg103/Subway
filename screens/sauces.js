...
export class Sauces{
    constructor(p5,navigateCallback){
      ...
      this.sauces = [
        new Sauce(this.p5.loadImage('../SUBWAY FOTOS/SAUCE/BBQ.png'), this.p5.loadImage('../SUBWAY FOTOS/TEXTS/BBQ.png')),
        new Sauce(this.p5.loadImage('../SUBWAY FOTOS/SAUCE/Mustard.png'), this.p5.loadImage('../SUBWAY FOTOS/TEXTS/mustard.png')),
        new Sauce(this.p5.loadImage('../SUBWAY FOTOS/SAUCE/HoneyMustard.png'), this.p5.loadImage('../SUBWAY FOTOS/TEXTS/honey.png')),
        new Sauce(this.p5.loadImage('../SUBWAY FOTOS/SAUCE/Chipotle.png'), this.p5.loadImage('../SUBWAY FOTOS/TEXTS/Chipotle.png')),
        new Sauce(this.p5.loadImage('../SUBWAY FOTOS/SAUCE/Garlic.png'), this.p5.loadImage('../SUBWAY FOTOS/TEXTS/Garlic.png')),
        new Sauce(this.p5.loadImage('../SUBWAY FOTOS/SAUCE/Mayonnaise.png'), this.p5.loadImage('../SUBWAY FOTOS/TEXTS/mayonnaise.png')),
      ];
    ...
    show(p5){
        ...
        for (let i = 0; i < this.sauces.length; i++) {
          ...
          const imageX = x + (columnSpacing - sauce.image.width) / 2;
          p5.image(sauce.image, imageX, y);

          const textX = x + (columnSpacing - sauce.text.width) / 2;
          const textY = y + sauce.image.height;
          p5.image(sauce.text, textX, textY);
